const DynatraceNavCopy = {
  ...
  cardSorting: {
    title: 'Closed Card Sorting',
    body: `
      <p>To understand how users mentally map the navigation system and to inform the structure, we conducted a closed card sorting study with 15-20 participants along with an exit survey. Using the UseBerry platform, participants were asked to categorize 40-80 items from the navigation menu.</p>
      <div classname="ul-group">
      <strong>Key Findings:</strong>
      <ul>
        <li>We identified common groupings of content and category names that made the most sense to users.</li>
        <li>We discovered common themes and frequently paired items, giving us insight into user priorities.</li>
        <li>The research revealed discrepancies between user assumptions (mental models) and the actual structure of the current navigation, helping us clarify and align the design with real user needs.</li>
      </ul>
      </div>
    `,
    assets: [
...
export default DynatraceNavCopy;
